# Create Database Initialization Scripts for Docker
Write-Host "CREATING DATABASE INITIALIZATION SCRIPTS" -ForegroundColor Blue
...
if (-not (Test-Path $dbDir)) {
    ...
    Write-Host "Created database/init directory" -ForegroundColor Green
}
...
Set-Content -Path "$dbDir/01-create-databases.sh" -Value $initScript -Encoding UTF8
...
Set-Content -Path "$dbDir/02-sample-data.sql" -Value $sampleDataScript -Encoding UTF8
Write-Host "Created sample data script" -ForegroundColor Green

Write-Host "`nDatabase initialization scripts created!" -ForegroundColor Green
Write-Host "Files created:" -ForegroundColor White
Write-Host "  database/init/01-create-databases.sh" -ForegroundColor Gray
Write-Host "  database/init/02-sample-data.sql" -ForegroundColor Gray
